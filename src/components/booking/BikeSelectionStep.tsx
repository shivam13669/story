        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 hover:shadow-xl transition-all -ml-2 sm:-ml-4"
            >
            ...
            >
              ...
              {isTransHimalayan && (
                <div
                  ...
                  className={`flex-shrink-0 w-[300px] sm:w-80 bg-gray-50 rounded-2xl shadow-sm hover:shadow-md transition-all p-5 cursor-pointer relative group overflow-hidden border-2 snap-center ${
              ...
              {backupVehicle && (
                <div
                  ...
                  className={`flex-shrink-0 w-[300px] sm:w-80 bg-gray-50 rounded-2xl shadow-sm p-5 relative group overflow-hidden border-2 snap-center ${
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 hover:shadow-xl transition-all -mr-2 sm:-mr-4"
            >
